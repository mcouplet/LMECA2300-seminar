...
```C
int window_is_closed(window_t* window)
```
in this manner
...
{
   color[0] = sin(0.8*a)*0.6+0.4;
   color[1] = sin(0.7*a)*0.6+0.4;
   color[2] = sin(0.57*a)*0.6+0.4;
   color[3] = 1; // solid
}
