...
void box(){
	// Parameters of the problem
	double R = 0.1;
	double l = 1.0; // particle distribution on [-l,l] x [-l,l]
	double L = 1.5; // size of the domain: [-L,L] x [-L,L]
	double H = 1.5;
	double dt = 1.0e-3; // physical time step
	...
	Boundary* boundary = Boundary_new(-d-Rp,d+Rp,-d-Rp,d+Rp,CR,CF);
